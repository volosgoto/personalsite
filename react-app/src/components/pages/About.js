        ...
        <div className="style-container">
          <div className="w3-container">
            <div className="w3-center">
              <h2>About</h2>
              <p>
                Hi! I am  an open-minded front-end developer with emotional
                inteligence that cares about how things look and work is in
                touch! In the same time i can implement some back-end as well).
              </p>
              <h2>Skills</h2>
            </div>
